...
const NavBar = () => {
  ...
  return(
	...
	<div className="Navbar2">
		<div >
		<div id="img11">
		<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRljMpu5g-m4-_HVcv8VlC0vzFjOwboXCAaXg&usqp=CAU"alt="" onClick={handleClick}  />
	</div>
		</div>
		<div className="borde flex justify-start ml-2 mr-8 text-sm font-semibold "  >
    <div className="p-5 borde orange1 cursor-pointer">
	Home
	</div>
	<div className="p-5 ml-5 orange1">
	About
	</div>
	<div className="p-5 ml-5 orange1">
	Shop
