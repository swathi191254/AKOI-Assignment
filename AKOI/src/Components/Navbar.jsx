    ...
    m = (
      <div>
        <div className="fixed bg-white top-24 p-2 right-20 w-25 h-30 z-50 shadow ">
          ...
          <div
            className="h-1/2 w-full p-2 bg-black-300 pl-5 color-white"
            onClick={() => {
              setLogin(false);
            }}
          >
    ...
    menu = (
      <div className="fixed bg-white top-0 right-0 w-1/3 h-full z-50 shadow  div3">
              ...
              return (
                <div classname="w-full h-1/5 border border-green-100 bg-white">
                  <div className="flex p-5 text-sm">
                    ...
                    <div className="ml-4 ">
                      <div className="mb-4">{item.id.title}</div>
                      <div className="flex">
                        <div>{item.id.cost}</div>
                      </div>
        ...
        <div className="border bg-blue-500 w-full h-16 fixed bottom-0 flex ">
          ...
          <div
            className="p-4  text-2xl text-white rounded-xl ml-36"
            onClick={() => {
              done();
            }}
          >
    ...
    <>
      <div className="Navbar2">
        <div>
          <div id="img11">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRljMpu5g-m4-_HVcv8VlC0vzFjOwboXCAaXg&usqp=CAU"
              alt=""
              onClick={handleClick}
            />
          </div>
        </div>
        <div className="borde flex justify-start ml-2 mr-8 text-sm font-semibold ">
          <div className="p-5 borde orange1 cursor-pointer">Home</div>
          <div className="p-5 ml-5 orange1">About</div>
          <div className="p-5 ml-5 orange1">Shop</div>
          <div className="p-5 ml-5 orange1">Export</div>
          <div className="p-5 ml-5 orange1">Blogs</div>
          <div className="p-5 ml-5 orange1">Contact</div>
        </div>

        <div className="mt ml-17">
          <PersonSharpIcon
            fontSize="large"
            className="cursor-pointer"
            onClick={() => {
